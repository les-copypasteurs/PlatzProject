                ...
                <div class="wrapper-text-description">
                    ...
                    <div class="wrapper-morefrom">
                        ...
                        <div class="image-morefrom">
                        	<a href="#"><div class="image-morefrom-1"><img v-bind:src="'/assets/img/' + post.image" alt="" width="430" height="330"/></div></a>
                        </div>
                    </div>
...
.image-reply-post{background: url(/assets/img/avatar.png) no-repeat;}
.image-reply-post-2{background: url(/assets/img/avatar-2.png) no-repeat;}
